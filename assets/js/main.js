...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        'fr': {
            ...
            'about_who_text1': 'Actuellement en B2 Informatique à Ynov, je suis passionné par le développement web et les nouvelles technologies. Mon parcours m\'a permis de développer une expertise variée, allant du développement front-end au back-end, en passant par l\'infrastructure et la gestion de bases de données.',
            'about_who_text2': 'Je m\'intéresse particulièrement à la création d\'applications web innovantes et à l\'optimisation des performances. Ma formation et mes projets personnels m\'ont permis de développer une approche méthodique et créative de la résolution de problèmes.',
            'about_path_title': 'Mon Parcours',
            'about_timeline_date': '2023 - Présent',
            'about_timeline_title': 'B2 Informatique',
        ...
        'en': {
            ...
            'about_who_text1': 'Currently in B2 Computer Science at Ynov, I am passionate about web development and new technologies. My journey has allowed me to develop varied expertise, ranging from front-end to back-end development, through infrastructure and database management.',
            'about_who_text2': 'I am particularly interested in creating innovative web applications and performance optimization. My training and personal projects have allowed me to develop a methodical and creative approach to problem solving.',
            'about_path_title': 'My Journey',
            'about_timeline_date': '2023 - Present',
            'about_timeline_title': 'B2 Computer Science',
            'about_timeline_school': 'Ynov Campus',
