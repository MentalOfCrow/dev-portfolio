...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        'fr': {
            ...
            // Page d'accueil
            'hero_subtitle': 'Cybersécurité • Infrastructure Cloud & Réseau • Développeur Full Stack',
            'hero_description': 'Passionné par les technologies, je sécurise et optimise les systèmes d\'information :<br><br>• Audits de vulnérabilités, durcissement et bonnes pratiques SecOps<br>• Infrastructures cloud & réseau robustes, virtualisation et DevOps<br>• Applications web performantes, back-ends fiables et interfaces soignées<br><br>Cette polyvalence me permet d\'adapter l\'architecture et la sécurité de chaque projet aux besoins réels des utilisateurs comme des équipes.',
            'hero_alternance_title': '🔎 Recherche d\'alternance',
            'hero_alternance_text': 'Disponible <strong>dès maintenant</strong> et jusqu\'à <strong>septembre 2026</strong>. Je recherche une alternance <strong>le plus tôt possible</strong> dans <strong>tous les domaines de l\'informatique</strong>.',
            ...
            'about_contact_intro': 'Ouvert aux échanges et à l\'étude de vos besoins (cybersécurité, infrastructure, développement web).',
            'about_contact_availability': 'Disponible <strong>dès maintenant</strong> et jusqu\'à <strong>septembre 2026</strong> pour une alternance — je recherche <strong>le plus tôt possible</strong>, dans <strong>tous les domaines de l\'informatique</strong>.',
            ...
            'about_interest4_desc': 'J\'approfondis la cybersécurité à travers la création et la résolution de challenges CTF.<br><strong>1ère année :</strong> Création de challenges pour <a href="https://hackin.fr" target="_blank" style="color:#10b981;text-decoration:underline;font-weight:bold;">Hack\'In</a> (ex-Hacky\'nov).<br><strong>2ème année :</strong> Participation à plusieurs CTF (Hack\'In, Ynov Aix-en-Provence, etc.).<br>Apprentissage continu en sécurité offensive et sensibilisation à la protection des données.',
            ...
            'experiences_subtitle': 'Stages et expériences professionnelles',
            'experiences_intro': 'Aperçu concis de mes expériences. Chaque stage est résumé en quelques lignes, avec un lien direct pour télécharger le rapport complet au format PDF.',
            // Page Expériences – blocs détaillés
            'meb_title': 'MEB — Stage 2023–2024',
            'meb_company_line': '<strong>Entreprise :</strong> MEB (Mobilité Énergie Bâtiment) — Bègles',
            'meb_summary': 'Immersion en économie de la construction : suivi de projets, coordination des intervenants, participation aux réceptions de travaux et mise à jour des tableaux de bord. Découverte des outils métier (MS Project, AutoCAD/Revit) et des processus DO.',
            'meb_tags': 'Gestion de projet · Suivi chantier · Bureautique pro',
            'shf_title': 'S.H.F. Informatique — Stage 2024–2025',
            'shf_company_line': '<strong>Entreprise :</strong> S.H.F. Informatique — Marseille',
            'shf_summary': 'Administration systèmes & réseaux : AD/DNS/DHCP/GPO, laboratoire Hyper-V et procédures. Maquette Fortinet, POC IDS (SELKS/Suricata) et standardisation pour réduire les incidents. Documentation opérationnelle et mini-formations internes.',
            'shf_tags': 'Windows Server · Hyper-V · GPO · Fortinet · Suricata/SELKS',
            'sicomin_title': 'Sicomin — Stage 2025–2026',
            'sicomin_company_line': '<strong>Entreprise :</strong> Sicomin — Châteauneuf-les-Martigues',
            'sicomin_summary': 'Stage de 4 mois (octobre 2025 – janvier 2026) en informatique. Missions en Data et Business Intelligence, cybersécurité et administration système. Travail sur site au sein d\'une entreprise spécialisée dans les résines époxy et matériaux composites.',
            'sicomin_tags': 'Data & BI · Cybersécurité · Administration système',
            'sicomin_badge': 'Stage terminé',
            'recherche_title': '2026 — Recherche d\'alternance',
            'recherche_summary': 'Recherche active d\'une alternance dans tous les domaines de l\'informatique : systèmes, réseaux, cybersécurité, développement, infrastructure cloud. Disponible dès maintenant et jusqu\'à septembre 2026. Ouvert à toutes les opportunités.',
            'recherche_tags': 'Tous domaines IT · Cybersécurité · Infrastructure · Développement',
            'recherche_badge': 'En recherche',
            'experiences_soon_title': 'À venir — 2025–2026',
            'soon_summary': 'Expérience en préparation dans le domaine des systèmes, réseaux et cybersécurité. Périmètre encore en cours de définition ; plus d’informations seront ajoutées prochainement.',
            'soon_tags': 'Systèmes & Réseaux · Cybersécurité · Observabilité',
            'soon_badge': 'En préparation',
            'pdf_download_fr_only': '📄 Télécharger le rapport (PDF — uniquement en français)',
            'experiences_b1_title': 'Stage – 2023–2024 (B1)',
            'experiences_b1_company': 'M.E.B.',
            'experiences_b1_period': 'Année 2023–2024',
            'experiences_b1_download': 'Télécharger le rapport complet (PDF)',
            'experiences_b2_title': 'Stage – Administrateur Systèmes, Réseaux & Cybersécurité',
            'experiences_b2_company': 'S.H.F. Informatique (Marseille)',
            'experiences_b2_period': '13 juin 2025 – 7 août 2025',
            'experiences_b2_supervisor': 'Encadrant : Alain Dadourian',
            'experiences_missions': 'Missions',
            'experiences_tools': 'Technos / Outils',
            'experiences_b2_download': 'Télécharger le rapport complet (PDF)',
            'experiences_coming_soon': 'D’autres expériences (B1, B3, alternance) seront ajoutées prochainement.',
            'experiences_soon_title': '2025–2026 — À venir',
        ...
        'en': {
            ...
            // Experiences – detailed blocks
            'meb_title': 'MEB — Internship 2023–2024',
            'meb_company_line': '<strong>Company:</strong> MEB (Mobilité Énergie Bâtiment) — Bègles',
            ...
            'shf_title': 'S.H.F. Informatique — Internship 2024–2025',
            'shf_company_line': '<strong>Company:</strong> S.H.F. Informatique — Marseille',
            'shf_summary': 'Systems & network administration: AD/DNS/DHCP/GPO, Hyper‑V lab and procedures. Fortinet mockup, IDS POC (SELKS/Suricata) and standardization to reduce incidents. Operational documentation and internal mini-trainings.',
            'shf_tags': 'Windows Server · Hyper‑V · GPO · Fortinet · Suricata/SELKS',
            'sicomin_title': 'Sicomin — Internship 2025–2026',
            'sicomin_company_line': '<strong>Company:</strong> Sicomin — Châteauneuf-les-Martigues',
            'sicomin_summary': '4-month internship (October 2025 – January 2026) in IT. Missions in Data and Business Intelligence, cybersecurity and system administration. On-site work within a company specialized in epoxy resins and composite materials.',
            'sicomin_tags': 'Data & BI · Cybersecurity · System Administration',
            'sicomin_badge': 'Internship completed',
            'recherche_title': '2026 — Seeking Work-Study/Apprenticeship',
            'recherche_summary': 'Actively seeking a work-study/apprenticeship in all IT fields: systems, networks, cybersecurity, development, cloud infrastructure. Available immediately and until September 2026. Open to all opportunities.',
            'recherche_tags': 'All IT fields · Cybersecurity · Infrastructure · Development',
            'recherche_badge': 'Seeking',
            'experiences_soon_title': '2025–2026 — Coming soon',
            ...
            'pdf_download_fr_only': '📄 Download the report (PDF — French only)',
            'experiences_b1_title': 'Internship – 2023–2024 (B1)',
            'experiences_b1_company': 'M.E.B.',
            'experiences_b1_period': 'Year 2023–2024',
            'experiences_b1_download': 'Download full report (PDF)',
            'experiences_b2_title': 'Intern – Systems, Networks & Cybersecurity',
            'experiences_b2_company': 'S.H.F. Informatique (Marseille)',
            'experiences_b2_period': 'June 13, 2025 – Aug 7, 2025',
            ...
            // Home page
            'hero_subtitle': 'Cybersecurity • Cloud Infrastructure & Network • Full Stack Developer',
            'hero_description': 'Passionate about technology, I secure and optimize information systems:<br><br>• Vulnerability audits, hardening and SecOps best practices<br>• Robust cloud & network infrastructures, virtualization and DevOps<br>• High-performance web applications, reliable back-ends and polished interfaces<br><br>This versatility allows me to adapt the architecture and security of each project to the real needs of users and teams.',
            'hero_alternance_title': '🔎 Seeking Work-Study/Apprenticeship',
            'hero_alternance_text': 'Available <strong>immediately</strong> and until <strong>September 2026</strong>. Seeking a work-study/apprenticeship <strong>as soon as possible</strong> in <strong>all IT fields</strong>.',
            ...
            'about_contact_intro': 'Open to discussions and to assessing your needs (cybersecurity, infrastructure, web development).',
            'about_contact_availability': 'Available <strong>immediately</strong> and until <strong>September 2026</strong> for a work-study/apprenticeship — seeking <strong>as soon as possible</strong>, in <strong>all IT fields</strong>.',
            'about_contact_email': 'hugo.bisserier.pro@gmail.com',
            'about_timeline_date': '2023 - 2025',
            ...
            'about_interest4_desc': 'I deepen cybersecurity through creating and solving CTF challenges.<br><strong>1st year:</strong> Creating challenges for <a href="https://hackin.fr" target="_blank" style="color:#10b981;text-decoration:underline;font-weight:bold;">Hack\'In</a> (ex-Hacky\'nov).<br><strong>2nd year:</strong> Participating in several CTFs (Hack\'In, Ynov Aix-en-Provence, etc.).<br>Continuous learning in offensive security and data protection awareness.',
